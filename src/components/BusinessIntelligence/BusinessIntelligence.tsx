        ...
        <Tabs.Panel value="businessInteligence" w={1042} h={734} style={{ padding: '12px 24px 12px 24px' }}>                  
          <Container w={677} h={58} p={0}  >
            ...
            <Text style={utilityClasses.bodyText}>
              ...
              <Container style={{...utilityClasses.featureContainer, position: 'relative', marginTop:'32px'}}>
                <Flex justify="space-between" align="flex-start">
                  ...
                  <Container w={127} h={105} style={{ margin: 0, padding: '8px'}}>
                    <Text style={{ fontSize: '14px', fontWeight: '600', marginBottom: '8px' }}>Examples</Text>
                    <Container style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                      <Button h={32} w={125} style={{ ...utilityClasses.grayButtons, }}>KYB report</Button>
                      <Button h={32} w={125} style={{ ...utilityClasses.grayButtons, }}>Business report</Button>
                    </Container>
                  </Container>
                </Flex>       
              </Container>
              ...
              <Container style={{ ...utilityClasses.featureContainer, marginTop: '12px' }}>
                ...
                <Text style={{ ...utilityClasses.bodyText, marginLeft: '8px' }}>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullambo laboris nisi ut aliquip ex ea commodo consequat.
                </Text>
                <Container style={{ marginLeft: '8px', marginTop: '8px' }}>
                  <Button 
                    style={{
