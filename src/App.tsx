...
import { theme, utilityClasses } from "./components/theme"; // Note the named import with curly braces
...
export const AppNew = memo((): ReactElement => {
  ...
  function DemoPage() {  
    ...
    <AppShell
      style={{
        backgroundImage: 'url("src/2def582a0161a731db4ed050ae500795814fe0b4.png")',
      ...
      <Container w={1042} h={840} style={{padding: '0' }}>
        ...
        <Flex style={{ alignItems: 'center' }} w={1042} h={41} justify="space-between">
          <Flex w={300} h={29} gap={28} style={{alignItems: 'center' }}>
            <Image w={135} h={29} src='src/Ondato_logo.png' alt="Ondato Logo" />
            <Text 
              w={137} 
              h={24} 
              style={{
        ...
        {/* Tabs container */}
        <Box w={1042} style={{marginTop: '24px',
        boxShadow: `
        ...
        `, borderRadius:'8px'}}>
          <Tabs defaultValue="idVerification" style={{ width: '100%', background:'#FFFFFF', borderRadius:'8px'}}>
            <Tabs.List h={41}>
